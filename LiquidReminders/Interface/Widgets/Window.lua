...
function LRP:CreateWindow(name, exitable, movable, resizable)
    ...
    if exitable then
        window:AddButton(
            "Interface\\Addons\\LiquidReminders\\Media\\Textures\\ExitCross.tga",
            function()
                window:Hide()
            end
        )
    ...
    if resizable then
        ...
        window.resizeFrame.tex:SetTexture("Interface\\Addons\\LiquidReminders\\Media\\Textures\\ResizeTriangle.tga")
